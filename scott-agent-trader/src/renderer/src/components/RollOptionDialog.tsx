                                ...
                                <table className="roll-chain-table">
                                    ...
                                    <tbody>
                                        ...
                                        {Array.from({ length: 10 }, (_, i) => (
                                            <tr key={`skel-${i}`}>
                                                <td className="roll-chain-cell roll-chain-call"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-cell roll-chain-call"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-cell roll-chain-call"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-cell roll-chain-call"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-strike"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-cell roll-chain-put"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-cell roll-chain-put"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-cell roll-chain-put"><span className="skeleton-bar" /></td>
                                                <td className="roll-chain-cell roll-chain-put"><span className="skeleton-bar" /></td>
                                            </tr>
                                        ...
                                        <tr className="roll-chain-expiry-row">
                                            <td>買價</td><td>賣價</td><td>最後價</td><td>Delta</td>
                                            <td className="roll-chain-expiry-label"><span className="skeleton-bar" style={{ width: 60 }} /></td>
                                            <td>買價</td><td>賣價</td><td>最後價</td><td>Delta</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            {limitDropdownOpen && priceOptions.length > 0 && createPortal(
                                ...
                                >
                                    {priceOptions.map((opt) => {
                                        const askVal = spreadPrices ? Math.max(spreadPrices.bid, spreadPrices.ask).toFixed(2) : ''
                                        const bidVal = spreadPrices ? Math.min(spreadPrices.bid, spreadPrices.ask).toFixed(2) : ''
