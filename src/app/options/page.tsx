                                                        ...
                                                        {Array.from({ length: 12 }, (_, i) => {
                                                            ...
                                                            return (
                                                                <tr key={stat.month} className={`border-b border-border/50 hover:bg-secondary/20 ${index % 2 === 0 ? 'bg-muted/30' : 'bg-card'}`}>
                                                                    ...
                                                                    <td className={`px-1 text-center h-7 border-r-2 border-border/60 ${Math.round(stat.total_profit) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                        {Math.round(stat.total_profit).toLocaleString()}
                                                                    </td>
                                                                    <td className={`px-1 text-center h-7 ${Math.round(stat.put_profit) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                        {Math.round(stat.put_profit).toLocaleString()}
                                                                    </td>
                                                                    <td className={`px-1 text-center h-7 ${Math.round(stat.call_profit) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                        {Math.round(stat.call_profit).toLocaleString()}
                                                                    </td>
                                                                    <td className={`px-1 text-center h-7 ${Math.round(stat.stock_pnl || 0) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                        {Math.round(stat.stock_pnl || 0).toLocaleString()}
                                                                    </td>
                                                                    <td className={`px-1 text-center h-7 ${Math.round(stat.interest || 0) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                ...
                                                <table className="w-full text-[13px] table-fixed">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className={`px-1 text-center h-7 border-r-2 border-border/60 ${Math.round(client.total_profit ?? 0) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                {Math.round(client.total_profit ?? 0).toLocaleString()}
                                                            </td>
                                                            <td className={`px-1 text-center h-7 ${Math.round(client.monthly_stats.reduce((sum, s) => sum + s.put_profit, 0)) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                {Math.round(client.monthly_stats.reduce((sum, s) => sum + s.put_profit, 0)).toLocaleString()}
                                                            </td>
                                                            <td className={`px-1 text-center h-7 ${Math.round(client.monthly_stats.reduce((sum, s) => sum + s.call_profit, 0)) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                {Math.round(client.monthly_stats.reduce((sum, s) => sum + s.call_profit, 0)).toLocaleString()}
                                                            </td>
                                                            <td className={`px-1 text-center h-7 ${Math.round(client.monthly_stats.reduce((sum, s) => sum + (s.stock_pnl || 0), 0)) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                                                {Math.round(client.monthly_stats.reduce((sum, s) => sum + (s.stock_pnl || 0), 0)).toLocaleString()}
                                                            </td>
                                                            <td className={`px-1 text-center h-7 ${Math.round(client.monthly_stats.reduce((sum, s) => sum + (s.interest || 0), 0)) < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
