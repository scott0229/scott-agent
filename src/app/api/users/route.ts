...
export async function PUT(req: NextRequest) {
    try {
        ...
        if (typeof managementFee !== 'undefined') {
            ...
            params.push(String(managementFee) !== '' ? parseFloat(managementFee as any) : 0);
        ...
        if (typeof feeExemptMonths !== 'undefined') {
            ...
            params.push(String(feeExemptMonths) !== '' ? parseInt(feeExemptMonths as any) : 0);
        }
        ...
        // Clear user cache to ensure fresh data on next fetch
        clearCache();
