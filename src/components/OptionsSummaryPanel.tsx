        ...
        <div className="rounded-md border bg-card mb-8 overflow-hidden shadow-sm">
            <div>
                <table className="w-full text-[13px] table-fixed">
                    <colgroup>
                        <col style={{ width: '140px' }} /> {/* Label Column */}
                        ...
                        <tr className="border-t hover:bg-table-row-hover bg-card">
                            ...
                            {users.map(user => {
                                ...
                                return isVisible ? (
                                    <td key={user.id} className="h-7 py-1 px-2 text-center">
                                        {(() => {
                                            const costBase = (user.initial_cost || 0) + (user.net_deposit || 0);
                        ...
                        {settings.includeStockDiffInPremium !== false && (
                            <tr className="border-t hover:bg-table-row-hover bg-muted/30">
                                ...
                                {users.map(user => {
                                    ...
                                    return isVisible ? (
                                        <td key={user.id} className={`h-7 py-1 px-2 text-center ${val < 0 ? 'bg-note-badge text-note-badge-fg' : ''}`}>
                                            {formatMoney(val)}
                                        </td>
                                    ) : null;
                                })}
