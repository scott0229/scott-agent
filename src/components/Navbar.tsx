...
export function Navbar() {
    ...
    return (
        <nav className="sticky top-0 w-full z-50 p-4 flex justify-between gap-2 bg-card/70 dark:bg-black/70 backdrop-blur-xl border-b border-foreground/15 dark:border-white/30 shadow-sm items-center">
            ...
            <div className="flex gap-2 items-center">
                ...
                <Link href="/trade-groups" prefetch={true}>
                    <Button
                        variant={pathname.startsWith('/trade-groups') ? "default" : "ghost"}
                        className="gap-2"
                    >
                        <svg
