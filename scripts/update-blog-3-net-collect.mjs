...
const oldStr = '<li><strong>淨收 (買回舊再賣出新)</strong>：+0.9</li>';
const newStr = '<li><strong>淨收 (買回舊再賣出新)</strong>：收益 +0.9 美元</li>';
...
const sqlPath = 'scripts/.tmp-update-blog-3-net-collect.sql';
