// Tweak roll purpose phrasing: 保住股票 → 保住股票賺更多價差.
...
const oldStr = '展期是為了保住股票，不是為了賺更多 call 權利金。';
const newStr = '展期是為了保住股票賺更多價差，不是為了賺更多 call 權利金。';
...
const sqlPath = 'scripts/.tmp-update-blog-4-roll-purpose.sql';
