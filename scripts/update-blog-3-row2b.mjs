// Reword row 2 - 平移 is not viable in this case (premium ≈ 0 at same strike).
...
const oldStr = '維持風險特性，展期收微薄權利金，不冒新風險';
const newStr = '不可行，因為此時同價位展期的權利金已幾乎為 0';

if (!original.includes(oldStr)) {
  console.error('ERROR: row 2 text not found.');
  process.exit(1);
}
...
const sqlPath = 'scripts/.tmp-update-blog-3-row2b.sql';
