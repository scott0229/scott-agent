...
const oldStr = '某交易者在 5/14（週四）做了一筆 sell call 的 roll：';
const newStr = '交易者在 5/14（週四）做了一筆 Sell Call 的展期：';
...
const sqlPath = 'scripts/.tmp-update-blog-4-trader-line.sql';
