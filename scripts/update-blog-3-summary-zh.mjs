// Drop the English jargon in the 總結 callout intro.
...
const oldStr = '展期是 base case。<strong>Default 是平移</strong>（同 strike，不冒新風險就收 credit）。要脫離 default，每個方向都該有明確目的：';
const newStr = '展期是基本動作。<strong>預設是平移</strong>（同行權價，不冒新風險就收權利金）。要脫離預設，每個方向都該有明確目的：';
...
const sqlPath = 'scripts/.tmp-update-blog-3-summary-zh.sql';
