// Remove the "展期成本為零" phrase from bullet 1.
...
const oldStr = '鎖定正股的獲利 + 已收的 call 權利金，展期成本為零。這通常是期望值最高的選擇。';
const newStr = '鎖定正股的獲利 + 已收的 call 權利金。這通常是期望值最高的選擇。';
...
const sqlPath = 'scripts/.tmp-update-blog-4-remove-zero-cost.sql';
