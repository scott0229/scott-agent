// Reword row 4 - 大幅上調 is viable (reasonable trade-off).
...
const oldStr = '為明顯多的 credit 放棄 buffer（積極），真的多收、真的多冒險';
const newStr = '可行，用合理的安全距離換合理的展期收入';

if (!original.includes(oldStr)) {
  console.error('ERROR: row 4 text not found.');
  process.exit(1);
}
...
const sqlPath = 'scripts/.tmp-update-blog-3-row4b.sql';
