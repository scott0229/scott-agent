// Plain-Chinese rewrite of "真正的 critique 是 ex-ante：...".
...
const oldStr = '真正的 critique 是 ex-ante：根本不該 defend；就算要 defend，+4 也太多。';
const newStr = '真正該檢討的是事前的決定：根本不該防守；就算要防守，也不該拉到 +4。';
...
const sqlPath = 'scripts/.tmp-update-blog-4-critique-plain.sql';
