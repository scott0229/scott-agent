...
const oldStr = '原 88C 已 ITM $1.38</strong>，平倉得花錢買回';
const newStr = '原 88C 已經被突破 1.38 個點</strong>';
...
const sqlPath = 'scripts/.tmp-update-blog-4-itm.sql';
