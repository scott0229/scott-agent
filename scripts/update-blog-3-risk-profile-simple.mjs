// Simplify the risk-profile gloss to just "(風險特性)".
...
const oldStr = '維持 risk profile（風險樣貌：指派機率、損益結構等都不變）';
const newStr = '維持 risk profile (風險特性)';
...
const sqlPath = 'scripts/.tmp-update-blog-3-risk-profile-simple.sql';
