...
const oldStr = '但這是後見之明，trade 時不能假設市場會這樣發展。';
const newStr = '雖然這是後見之明、馬後炮，但交易時應該不能排除市場會這樣發展。';
...
const sqlPath = 'scripts/.tmp-update-blog-4-hindsight-phrase.sql';
