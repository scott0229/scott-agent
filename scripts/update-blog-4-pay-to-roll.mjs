// Rewrite the "對賣方來說，付錢 roll..." opener.
...
const oldStr = '對賣方來說，<strong>付錢 roll</strong> 是少見的情境 — 通常代表原部位已經被打到價內';
const newStr = '對賣方來說，<strong>付錢展期</strong>是很少見，通常代表行權價被突破，而且不想讓正股被指派';
...
const sqlPath = 'scripts/.tmp-update-blog-4-pay-to-roll.sql';
