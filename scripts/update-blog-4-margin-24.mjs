// Shrink left/right margins to 24 px each by shifting viewBox + rect.
// viewBox "0 0 768 280" → "24 0 720 280" (shows the inner 720 px)
// rect x=0 width=768 → x=24 width=720 (so rounded corners land at visible edges)
...
const replacements = [
  ['viewBox="0 0 768 280"', 'viewBox="24 0 720 280"'],
  ['<rect x="0" y="0" width="768" height="280" fill="#fbf6ef" rx="10"/>',
   '<rect x="24" y="0" width="720" height="280" fill="#fbf6ef" rx="10"/>'],
];
...
const sqlPath = 'scripts/.tmp-update-blog-4-margin-24.sql';
