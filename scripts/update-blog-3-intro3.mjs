...
const oldStr = '展期一定要做 — 問題只剩一個：<strong>新的行權價該怎麼決定？</strong>';
const newStr = '在股價大幅拉升時行權價本來積極調整，交易者在被提醒之後執行了以下的操作，我們來分析一下問題出在哪？';
...
const sqlPath = 'scripts/.tmp-update-blog-3-intro3.sql';
