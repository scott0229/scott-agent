...
const oldStr = '每多 1 pp buffer 平均付了 ~$31';
const newStr = '每多 1% buffer 平均付了 ~$31';
...
const sqlPath = 'scripts/.tmp-update-blog-4-pp-to-percent.sql';
