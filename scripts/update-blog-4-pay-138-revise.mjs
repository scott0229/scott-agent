// "所以付出 $138.5 完成展期" → "所以要付 $138.5 才得以完成展期"
...
const oldStr = '所以付出 $138.5 完成展期';
const newStr = '所以要付 $138.5 才得以完成展期';
...
const sqlPath = 'scripts/.tmp-update-blog-4-pay-138-revise.sql';
