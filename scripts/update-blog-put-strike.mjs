...
const content = `<figure style="margin:28px 0;padding:0;">
  ...
  <figcaption style="text-align:center;color:#8a7864;font-size:0.875rem;margin-top:10px;font-style:italic;">5/14 衝高 $719.79、5/15 拉回 $708.93（-1.51%），5 日均線仍穩在 $692 行權價之上。</figcaption>
</figure>
...
<div style="border:1px solid #d4b896;background:#fdfaf2;color:#3a3025;padding:18px 22px;margin:24px 0;border-radius:8px;">
  ...
  <p style="margin:8px 0;"><strong>2. 非對稱 ratchet 效應（複利毒性）。</strong>真正的問題不是「跌就 roll down」這一次，而是<strong>反彈時你照樣 roll up 追股價，卻追不回原本的 strike</strong> — 上一波 IV 還沒完全回落、股價自己也沒完全收復，同樣選 delta 0.15 對應的 strike 就是會比起點低一截，<strong>權利金跟著再縮一次水</strong>。每跌一波就被拉低、每彈一波只能追回一部分 — <strong>strike 跟權利金一起單向往下 ratchet</strong>。看一個溫和震盪市的數字：</p>
  <table style="width:100%;border-collapse:collapse;margin:14px 0;font-size:0.875rem;background:#fff;border-radius:6px;overflow:hidden;">
    ...
    <tbody>
      ...
      <tr><td style="padding:7px 10px;">5（反彈）</td><td style="padding:7px 10px;">716</td><td style="padding:7px 10px;">19%</td><td style="padding:7px 10px;">688</td><td style="padding:7px 10px;">$1.00</td></tr>
    </tbody>
  </table>
  <p style="margin:8px 0;">5 次展期後 strike 少 4 點，<strong>權利金已經少 17%</strong>。遇到 2022 那種持續跌 + IV 結構性高的環境，半年下來權利金腰斬不誇張。</p>
