// Prefix the cost basis line with "該帳戶目前".
...
const oldStr = 'COPX 持股的成本是 $80.54';
const newStr = '該帳戶目前 COPX 持股的成本是 $80.54';
...
const sqlPath = 'scripts/.tmp-update-blog-4-cost-account.sql';
