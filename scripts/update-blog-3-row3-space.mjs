// Add space before parenthesis in row 3.
...
const oldStr = 'strike 拉低(646→640)';
const newStr = 'strike 拉低 (646→640)';
...
const sqlPath = 'scripts/.tmp-update-blog-3-row3-space.sql';
