// Reword row 2 of the roll-options table.
...
const oldStr = '維持 risk profile (風險特性) — <span style="color:#8a7864;">收一點 credit，不冒新風險</span>';
const newStr = '維持風險特性，展期收微薄權利金，不冒新風險';

if (!original.includes(oldStr)) {
  console.error('ERROR: row 2 cell not found.');
  process.exit(1);
}
...
const sqlPath = 'scripts/.tmp-update-blog-3-row2.sql';
