// Reword row 3 - 下調 is also not viable (buffer already sufficient).
...
const oldStr = '為 buffer 付 credit（防守），少收 credit、多買安全距離';
const newStr = '不可行，行權價、股價間的安全距離已足夠大';
...
const sqlPath = 'scripts/.tmp-update-blog-3-row3b.sql';
