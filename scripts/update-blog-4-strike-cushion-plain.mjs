// Plain-Chinese: "多買的這 2 個 strike 的 cushion" → "多買的這 2 個點的行權價緩衝".
...
const oldStr = '多買的這 2 個 strike 的 cushion';
const newStr = '多買的這 2 個點的行權價緩衝';
...
const sqlPath = 'scripts/.tmp-update-blog-4-strike-cushion-plain.sql';
