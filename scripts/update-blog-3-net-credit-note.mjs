// Add a parenthetical to the 淨收 bullet.
...
const oldStr = '<li><strong>淨收</strong>：+0.9</li>';
const newStr = '<li><strong>淨收 (買回舊再賣出新)</strong>：+0.9</li>';

if (!original.includes(oldStr)) {
  console.error('ERROR: bullet not found.');
  process.exit(1);
}
...
const sqlPath = 'scripts/.tmp-update-blog-3-net-credit-note.sql';
