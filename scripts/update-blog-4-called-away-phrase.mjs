// Simplify the premise phrasing: "被 call 走只是換現金、不是虧損" → "被 call 走只是獲利了結".
...
const oldStr = '被 call 走只是換現金、不是虧損';
const newStr = '被 call 走只是獲利了結';
...
const sqlPath = 'scripts/.tmp-update-blog-4-called-away-phrase.sql';
